import Root from "./selectors/root.js";
import Selector from "./selectors/selector.js";
import ClassName from "./selectors/className.js";
import Comment from "./selectors/comment.js";
import ID from "./selectors/id.js";
import Tag from "./selectors/tag.js";
import Str from "./selectors/string.js";
import Pseudo from "./selectors/pseudo.js";
import Attribute, { unescapeValue } from "./selectors/attribute.js";
import Universal from "./selectors/universal.js";
import Combinator from "./selectors/combinator.js";
import Nesting from "./selectors/nesting.js";
import sortAsc from "./sortAscending.js";
import tokenize, { FIELDS as TOKEN } from "./tokenize.js";
import * as tokens from "./tokenTypes.js";
import * as types from "./selectors/types.js";
import { ensureObject, getProp, unesc } from "./util/index.js";
...
export default class Parser {
  constructor(rule, options = {}) {
    ...
    let rootSource = getTokenSourceSpan(
      this.tokens[0],
        ...
        case tokens.space:
          ...
          if (lastAdded) {
            ...
            const existingComment =
              getProp(node, "raws", "spaces", lastAdded, "after") || null;
          ...
          if (lastAdded) {
            if (
              ...
              const rawLastComment =
                getProp(node, "raws", "spaces", lastAdded, "after") ||
                lastComment;
              ...
              const rawLastValue = getProp(node, "raws", lastAdded) ||
                lastValue;
              ensureObject(node, "raws");

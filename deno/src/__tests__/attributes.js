import { process } from "../../deps.js";
import Attribute from "../selectors/attribute.js";
import { nodeVersionAtLeast, nodeVersionBefore, test } from "./util/helpers.js";
...
test(
  ...
  (t, tree) => {
    ...
    t.deepEqual(
      attr.getQuotedValue({ quoteMark: null }),
      'Something\\ \\"weird\\"',
    );
    t.deepEqual(attr.quoteMark, '"');
    t.truthy(attr.quoted);
